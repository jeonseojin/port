			...
			<table class="table">
				<thead>
					<tr class="textline-center">
						...
						<th class="adt-plot">충전코인</th>
						<th class="adt-plot">이벤트 코인(기간)</th>
						<th class="adt-plot">결제&이벤트 코인 내역</th>
						<th class="adt-plot">코인 유효기간</th>
