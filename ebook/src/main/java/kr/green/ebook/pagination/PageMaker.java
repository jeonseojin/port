...
public class PageMaker {
	private int totalCount;//총 게시물의 갯수 마지막 페이지를 결정하기 위해서 필요
	private int startPage;
	private int endPage;
	private boolean prev;//페이지네이션으로 갈 것인지 아닌지
	private boolean next;
	private int displayPageNum = 10;//한 페이지네이션에 보여지는 갯수
	private Criteria cri; // 현재 페이지의 정보
